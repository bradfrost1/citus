...
tool.
  ...
  # 0.60 or greater. If you don't use Ubuntu and your package manager has a more
  # recent version of uncrustify feel free to skip this part.
...
correct the style of any source files in the current directory.
